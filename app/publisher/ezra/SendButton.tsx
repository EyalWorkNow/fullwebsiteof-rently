...
// The same liquid-bubble send button אתי uses (app/ati/AtiWorkspace.tsx), on the
// Rently design tokens (primary #2563EB / sky #38B6FF). Rendered as a plain
// button until mount so the styled-components markup never mismatches on SSR.
...
const StyledUiverseWrapper = styled.div`
  .uiverse {
    ...
    --c-color-2: #2563eb;
    --c-color-3: #38b6ff;
    --c-color-4: rgba(37, 99, 235, 0.85);
    --c-shadow: rgba(37, 99, 235, 0.4);
    --c-shadow-inset-top: rgba(186, 230, 253, 0.9);
    --c-shadow-inset-bottom: rgba(37, 99, 235, 0.8);
